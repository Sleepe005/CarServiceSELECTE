...
public class Cars {
    ...
    public Cars(String brand, String model, String generation,
                java.time.LocalDate year_from, java.time.LocalDate year_to, Long price, Long safety_rating,
                ...
                String drivetrain, Long power_hp, String additional_options, java.time.LocalDate last_updated){
        this.brand = brand;
        this.model = model;
